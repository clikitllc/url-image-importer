 ...
 * @since 1.0.0
 */
class UrlBigFileUploads {

	/**
	 * UrlBigFileUploads instance.
	 *
	 * @since  1.0.0
	 * @access private
	 * @static
	 * @var UrlBigFileUploads
	 */
	 ...
	 * UrlBigFileUploads is loaded or can be loaded.
	 *
	 * @return UrlBigFileUploads
	 * @since 1.0.0
	 * @static
	 *
	 */
	...
	public function init_review_notice() {
		...
		// Setup notice.
		if( class_exists( 'Big_File_Uploads_Review_Notice' ) ){
...
$big_file_uploads = UrlBigFileUploads::get_instance();
